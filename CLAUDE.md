...
- Evidence scaffold command and exit code (`pnpm run verify:evidence:scaffold:win`)
...
- Completion workflow/product status values (`workflow_status`, `product_status`, `open_p0_issues`)
