...
async function seedDatabase() {
  if (shouldLog('info')) console.log('[Database] Seeding database with app settings...');

  try {
    const seedSettings = [
      { key: 'app_name', value: 'Population Simulation Prototype' },
    ...
    if (shouldLog('info')) console.log('[Database] Successfully seeded app_settings with', seedSettings.length, 'entries');
  } catch (error) {
